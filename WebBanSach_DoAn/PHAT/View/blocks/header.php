...
<head>
    ...
    <link rel="stylesheet" href="./PHAT/public/css/main.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/8.0.1/normalize.min.css">
    <link rel="stylesheet" href="./PHAT/public/font/fontawesome-free-6.6.0-web/css/all.min.css">
            ...
            <nav class="header__navbar">
                <ul class="header__navbar-list">
                    <li class="header__navbar-item header__navbar-item--qr header__navbar-item--separate">
                        Vào cửa hàng trên web Svn.com
                        <div class="header__qr">
                            <img src="./PHAT/public/image/QRCodepng.png" alt="QR_code" class="header__qr-img">
                            <div class="header__qr-apps">
                                <img src="./PHAT/public/image/App_Store.png" alt="App Store" class="header__qr-down-img">
                                <img src="./PHAT/public/image/GG_Play.png" alt="Google Play" class="header__qr-down-img">
                            </div>
                        </div>
                    </li>
                ...
                <ul class="header__navbar-list">
                    ...
                    <!-- <li class="header__navbar-item"><a href=""
                                class="header__navbar-item-link header__navbar-item-link--strong header__navbar-item--separate">Đăng
                                nhập</a></li>
                        <li class="header__navbar-item"><a href=""
                                class="header__navbar-item-link header__navbar-item-link--strong">Đăng kí</a></li> -->
                    <li class="header__navbar-item header__navbar-user">
                        ...
                        <span class="header__navbar-user-name">Son Nguyen</span>
